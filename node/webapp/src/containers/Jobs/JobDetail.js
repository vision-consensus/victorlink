...
import {Button, Card, Col, PageHeader, Row, Steps, Table, Tabs} from 'antd';
                                    ...
                                    <Steps direction="vertical" progressDot>
                                        {
                                            taskList.map((item, index) => (
                                                <Step key={index} title={item.type} status={ant_status[item.status]}
                                                      style={index != (taskList.length - 1) ? {paddingBottom: '20px'} : {}}/>
                                            ))
                                        }
