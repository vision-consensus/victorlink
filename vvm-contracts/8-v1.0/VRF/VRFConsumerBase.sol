...
import "./VictorlinkClientVRF.sol";
 ...
 */
abstract contract VRFConsumerBase is VRFRequestIDBase, VictorlinkClientVRF {
     ...
     * @param _fee The amount of WVS to send with the request
    ...
    function requestRandomness(
        ...
        require(
            victorMid.transferAndCall(
                ...
                vrfCoordinator,
                _fee,
                encodeVRFRequest(_req)
            ),
            "vrfCoordinator transfercall failed"
        );
        ...
        // successful victorMid.transferAndCall (in VRFCoordinator.randomnessRequest).
