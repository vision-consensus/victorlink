...
contract VRF {
  ...
  {
    require(scalar != 0,"invalid scalar"); // Rules out an ecrecover failure case
  ...
  */
  ...
  function linearCombination(
    ...
    internal pure returns (uint256[2] memory) {
      ...
      require(ecmulVerify(p1, c, cp1Witness), "First check failed");
      require(ecmulVerify(p2, s, sp2Witness), "Second check failed");
